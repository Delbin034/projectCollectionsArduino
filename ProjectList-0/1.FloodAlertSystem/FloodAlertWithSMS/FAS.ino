...
String alertNumbers[] = {
  "+919485855555",   // <-- REPLACE with real 13-char number
  "+919489833334"    // <-- REPLACE with real 13-char number
};
...
// sensor acknowledged the wake-up write.
bool mpuInit()
{
  ...
  if (wakeResult != 0)
  {
    return false; // no ACK from the sensor - not found/wired wrong
  }
